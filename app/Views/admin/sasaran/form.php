        ...
        <div class="row mb-3">
            <div class="col-lg col-xxl-5">
                <div class="row">
                    ...
                    <div class="col">
                        Nama Sasaran:<br />
                        <input type="text" name="n_sasaran" value="<?php if (isset($detail['n_sasaran'])) echo $detail['n_sasaran']; ?>" class="form form-control form-50" size="40" />
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#add_submit').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= site_url('admin2053/sasaran/submitdata') ?>",
                headers: {
