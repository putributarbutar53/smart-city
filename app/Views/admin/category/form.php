         ...
         <div class="row mb-3">
             <div class="col-lg col-xxl-5">
                 <div class="row">
                     ...
                     <div class="col">
                         Category:<br />
                         <input type="text" name="nama" value="<?php if (isset($detail['nama'])) echo $detail['nama']; ?>" class="form form-control form-50" size="40" />
                     </div>
                 </div>
                 ...
                 <div class="row mt-3">
                     <div class="col">
                         Description:<br />
                         <textarea name="desc" class="form form-control" rows="4" cols="40"><?php if (isset($detail['desc'])) echo $detail['desc']; ?></textarea>
                     </div>
                 </div>
